...
export const FortuneWheel3DIcon: React.FC<FortuneWheel3DIconProps> = ({
  ...
  return (
    ...
    >
      <svg
        viewBox="0 0 120 120"
        className={`w-full h-full drop-shadow-[0_8px_16px_rgba(245,158,11,0.4)] ${
      ...
      >
        <defs>
          ...
          <radialGradient id="goldBevel" cx="50%" cy="50%" r="50%">
            <stop offset="75%" stopColor="#5D4037" stopOpacity="0.8" />
        ...
        {/* Top 3D Golden Pointer (Needle) pointing down to wheel */}
      ...
      <div className="absolute inset-0 rounded-full bg-amber-400/25 blur-md -z-10 animate-pulse pointer-events-none" />
    </div>
  );
};
