...
export const layout = {
  ...
  toast: {
    ...
    roleSwitchedOwner: 'Role changed to "Landlord".',
    roleSwitchedAgent: 'Role changed to "Real-estate agent".',
    roleSwitchedStudent: 'Role changed to "Student".',
    ...
    welcomeAgent: 'Welcome! You can now post on behalf of the owners you represent.',
