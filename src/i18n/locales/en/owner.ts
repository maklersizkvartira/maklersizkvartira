...
export const owner = {
  ...
  create: {
    ...
    location: {
      ...
      pickTitle: 'Mark it on the map',
      pickBody: 'Tap the point on the map where the property is.',
      pickHint: 'Tap the map to choose a point',
      pickConfirm: 'Use this location',
      pickCta: 'Choose on the map',
    ...
    details: {
      ...
      priceLabelSale: 'Sale price',
      pricePlaceholderSale: 'For example: 600,000,000',
      pricePlaceholderSaleUsd: 'For example, 50,000',
      ...
      currencyUzs: 'so‘m',
      currencyUsd: '$ dollar',
      pricePlaceholderUsd: 'For example, 500',
      depositPlaceholder: 'Enter 0 if there is no deposit',
      depositPlaceholderUsd: 'Enter 0 if there is none',
