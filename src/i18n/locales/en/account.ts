...
export const account = {
  ...
  wallet: {
    ...
    methods: 'Via Click or Payme. Your card details never reach this site.',
    servicesTitle: 'Services',
    badgeTitle: 'Official blue check',
    badgeDesc: 'A verified mark next to your name and more trust in your listings.',
    badgeActive: 'Active',
    badgeBuy: 'Buy',
    badgeConfirmTitle: 'Buy the blue check?',
    badgeConfirmBody: '{price} so‘m will be taken from your balance. The mark activates at once and is not refundable.',
    badgeBenefit1: 'Blue check next to your name',
    badgeBenefit2: '“Verified owner” mark on your listings',
    badgeBenefit3: 'Higher trust score',
    badgeShortfall: 'Your balance is {amount} so‘m short.',
    badgeTopUp: 'Top up {amount} so‘m',
    badgeBought: 'Blue check activated!',
    confirm: 'Confirm',
