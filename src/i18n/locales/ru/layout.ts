...
export const layout = {
  ...
  toast: {
    ...
    roleSwitchedOwner: 'Роль изменена на «Владелец жилья».',
    roleSwitchedAgent: 'Роль изменена на «Агент по недвижимости».',
    roleSwitchedStudent: 'Роль изменена на «Студент».',
    ...
    welcomeAgent: 'Добро пожаловать! Теперь вы можете размещать объявления от имени клиентов.',
