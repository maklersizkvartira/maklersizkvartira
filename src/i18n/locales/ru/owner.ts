...
export const owner = {
  ...
  create: {
    ...
    location: {
      ...
      pickTitle: 'Отметьте на карте',
      pickBody: 'Нажмите на карте точку, где находится сдаваемое жильё.',
      pickHint: 'Нажмите на карту, чтобы выбрать точку',
      pickConfirm: 'Выбрать это место',
      pickCta: 'Выбрать на карте',
    ...
    details: {
      ...
      currencyUzs: 'сум',
      currencyUsd: '$ доллар',
      pricePlaceholderUsd: 'Например, 500',
      depositPlaceholder: 'Если залога нет — 0',
      depositPlaceholderUsd: 'Если залога нет — 0',
    ...
    photos: {
      ...
      countHint: 'Загрузите от {min} до {max} фото.',
