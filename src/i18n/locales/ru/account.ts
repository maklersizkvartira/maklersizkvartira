...
export const account = {
  ...
  topUp: {
    ...
    close: 'Закрыть',
    cancelledTitle: 'Платёж не завершён',
    cancelledBody: 'Вы вернулись со страницы оплаты. Баланс не изменился — при желании попробуйте ещё раз.',
    paidToast: 'Баланс пополнен на {amount} сум',
    checking: 'Проверяем платёж…',
    leaveNote: 'Сейчас откроется страница {gateway}. Если передумаете — просто вернитесь сюда.',
  },

  wallet: {
    promoteBought: 'Объявление продвинуто',
    promoteShortfall: 'На балансе не хватает {amount} сум',
    title: 'Кошелёк',
