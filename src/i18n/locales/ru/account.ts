...
export const account = {
  ...
  role: {
    ...
    agent: {
      ...
      description: 'Размещать от имени собственника',
    },
    student: {
      title: 'Студент',
    ...
    active: 'Текущая роль',
    agencyTitle: 'Ваше агентство',
    agencySubtitle: 'Это название показывается рядом с вашими объявлениями.',
    ...
    agencySaved: 'Название агентства сохранено.',
    agencyFailed: 'Не удалось сохранить название агентства.',
  ...
  wallet: {
    title: 'Кошелёк',
    subtitle: 'Баланс, пополнение и услуги',
    balance: 'Баланс',
    topUp: 'Пополнить баланс',
    methods: 'Через Click или Payme. Данные карты на сайт не попадают.',
    servicesTitle: 'Услуги',
    badgeTitle: 'Официальная синяя галочка',
    badgeDesc: 'Знак подтверждения рядом с именем и больше доверия к вашим объявлениям.',
    badgeActive: 'Активна',
    badgeBuy: 'Купить',
    badgeConfirmTitle: 'Купить синюю галочку?',
    badgeConfirmBody: 'С баланса спишется {price} сум. Знак активируется сразу и не возвращается.',
    badgeBenefit1: 'Синяя галочка рядом с именем',
    badgeBenefit2: 'Метка «Подтверждённый владелец» в объявлениях',
    badgeBenefit3: 'Выше рейтинг доверия',
    badgeShortfall: 'На балансе не хватает {amount} сум.',
    badgeTopUp: 'Пополнить на {amount} сум',
    badgeBought: 'Синяя галочка активирована!',
    confirm: 'Подтвердить',
