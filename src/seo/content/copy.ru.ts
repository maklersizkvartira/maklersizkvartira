    ...
    faq: [
      ...
      },
      {
        ...
        a:
          ...
          + 'бесплатны. Платные только необязательные подписки, их условия — в Публичной оферте. '
          + 'Любой, кто от имени площадки просит перевести деньги на карту, нарушает правила, и '
